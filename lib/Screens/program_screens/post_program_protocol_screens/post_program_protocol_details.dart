...
class PostProgramProtocolDetails extends StatefulWidget {
  const PostProgramProtocolDetails({ Key? key }) : super(key: key);

  @override
  State<PostProgramProtocolDetails> createState() => _PostProgramProtocolDetailsState();
}

class _PostProgramProtocolDetailsState extends State<PostProgramProtocolDetails> {
  @override
