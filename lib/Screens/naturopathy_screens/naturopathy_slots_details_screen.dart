...
import 'package:gut_wellness_app/Screens/naturopathy_screens/naturopathy_calender_time_screen.dart';
import 'package:gut_wellness_app/widgets/widgets.dart';
import 'package:sizer/sizer.dart';

import 'package:gut_wellness_app/widgets/constants.dart';

import 'naturopathy_consultation_completed.dart';

class NaturopathySlotsDetailsScreen extends StatelessWidget {
  final String bookingDate;
  final String bookingTime;
  const NaturopathySlotsDetailsScreen({
    Key? key,
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                            builder: (context) =>
                                                NaturopathyConsultationCompleted(
